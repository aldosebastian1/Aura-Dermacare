...
const Hero: React.FC = () => {
  return (
    <section className="relative min-h-[900px] flex items-start pt-5 pb-20 px-8 overflow-hidden bg-white/50">
      <div className="max-w-7xl mx-auto editorial-grid">
        ...
        {/* Right Visual Column */}
        <div className="col-span-12 lg:col-span-5 relative mt-0 lg:mt-0">
          <div className="rounded-2xl asymmetric-border overflow-hidden bg-[#f2f4f4] h-[550px] lg:h-[650px] relative shadow-[0_32px_64px_rgba(25,28,29,0.12)]">
            <img
            ...
            <div className="absolute bottom-10 bg-white p-7 rounded-[2rem] shadow-[0_20px_40px_rgba(25,28,29,0.08)] max-w-[260px] border border-[#e6e8e9]">
              ...
              <div className="grid grid-cols-2 gap-2">
                ...
                <div className="rounded-xl bg-[#f2f4f4] h-24 overflow-hidden">
                  <img
                    className="w-full h-full object-cover"
