...
const Footer: React.FC = () => {
  return (
    <footer className="bg-slate-50 dark:bg-slate-950 w-full pt-20 pb-10 text-left">
      <div className="max-w-7xl mx-auto px-8 grid grid-cols-1 md:grid-cols-4 gap-12 font-body text-sm">
        <div className="col-span-1 md:col-span-1 space-y-6">
          <span className="text-lg font-bold text-emerald-900 tracking-tighter uppercase">AURA DERMACARE</span>
          <p className="text-slate-500 leading-relaxed">Pusat estetika medis terpercaya dengan fokus pada kesehatan kulit jangka panjang dan hasil natural.</p>
        </div>
        <div className="space-y-6">
          <h5 className="font-bold text-emerald-700">Clinic Address</h5>
        ...
        <div className="space-y-6">
          <h5 className="font-bold text-emerald-700">Policies</h5>
        ...
        <div className="space-y-6">
          <h5 className="font-bold text-emerald-700">Legal Info</h5>
